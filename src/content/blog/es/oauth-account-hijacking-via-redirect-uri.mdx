...
<RequestDiff
  left="oauth-account-hijacking-via-redirect-uri/08-auth.http"
  right="oauth-account-hijacking-via-redirect-uri/11-auth.http"
  leftLabel="redirect_uri normal"
  rightLabel="redirect_uri secuestrado"
/>
