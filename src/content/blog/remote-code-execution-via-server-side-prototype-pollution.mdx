...
The mutation is just that extra key on an otherwise normal address body:

<RequestDiff
  left="remote-code-execution-via-server-side-prototype-pollution/04-clean.json"
  right="remote-code-execution-via-server-side-prototype-pollution/04-body.json"
  leftLabel="Normal address JSON"
  rightLabel="Polluted address JSON"
/>
